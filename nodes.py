...
class GrokSDXLPromptBatch:
    ...
    def _build_system_prompt(self, lora_mode, relevant, lora_indexer, seed_style):
        parts = [
            ...
            "1. When generating batches with people, you absolutely MUST randomly cycle through physical traits AND locations.",
            "2. LOCATION/BACKGROUND: Randomly alternate the setting for each prompt (e.g., bustling city street, quiet cafe, lush forest, futuristic laboratory, neon-lit alleyway, sunlit beach, dark ancient ruins, modern office, outer space, cozy living room, snowy mountain, cyberpunk market).",
            "3. HAIR COLOR: Randomly alternate between blonde, redhead, brunette, black hair, silver hair, etc.",
            "4. ETHNICITY: Randomly alternate between Asian, European, Slavic, African, Hispanic, Middle Eastern, etc.",
            "5. BODY TYPE: Randomly alternate between skinny, athletic, perfect figure, curvy, overweight, muscular, petite, etc.",
            "6. AGE: Randomly assign ages between 18 and 60 years old.",
            "7. NO DUPLICATES: Never generate two prompts in a row with the exact same combination of location, hair, ethnicity, body type, and age.",
            "8. Explicitly write these diverse environmental details and character traits into the tags for every single prompt you generate.",
            "",
