...
class GrokSDXLPromptBatch:
    ...
    def _build_system_prompt(self, lora_mode, relevant, lora_indexer, seed_style):
        parts = [
            ...
            "",
            "SUBJECT DIVERSITY (CRITICAL):",
            "1. When generating multiple prompts involving people, you MUST actively diversify their physical appearance across the batch.",
            "2. Radically vary facial structures, ethnic backgrounds, skin tones (pale, tanned, dark, olive, etc.), body types, ages, and hairstyles.",
            "3. DO NOT generate the same generic default face or body every time; rigorously specify unique physical traits for each individual prompt.",
            "",
