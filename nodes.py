...
class GrokSDXLPromptBatch:
    ...
    def _build_system_prompt(self, lora_mode, relevant, lora_indexer, seed_style):
        parts = [
            ...
            "5. NO DUPLICATES: Never generate two prompts in a row with the exact same combination of hair, ethnicity, and body type.",
            "6. Explicitly write these traits into the tags for every single person you generate.",
            "",
